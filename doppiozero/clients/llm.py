...
class LLMClient:
    ...
    def _call_openai_api(
        ...
        # default: chat/generation. MAX_TOKENS is controlled exclusively by the
        # MAX_TOKENS environment variable per project policy.
    ...
    def generate(self, prompt: str, model: Optional[str] = None) -> str:
        ...
        Note:
            The maximum number of tokens requested from the API is read from the
            `MAX_TOKENS` environment variable and cannot be overridden via the
            function call.
